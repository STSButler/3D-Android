...
This section creates a cube programmatically, however 
CubeViewRenderer.java uploads a prepared 
cube with vertices and texels
to apply one cross formatted
texture map for each cube view.
*/
